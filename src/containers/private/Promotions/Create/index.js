...
class CreateManagement extends Component {
  ...
  handleSubmit = async (values, actions) => {
    ...
    try {
          ...
          console.log(startDateTime.format('YYYY-MM-DD HH:mm:ss'))
          ...
          values.is_toppromotion && (formData.append('is_toppromotion', values.is_toppromotion));
          values.is_gps && (formData.append('is_gps', values.is_gps));
