    ...
    return (
      <div>
        ...
        <div style={{display: 'flex', alignItems: 'center', padding: '30px', background: '#F3F3F6' , border:'1px solid #E6ECF5'}} >
            ...
            <h1 style={{margin: '0 20px', color: '#5a5e76', fontSize: '40px' }}>Francine Narciso</h1>
        </div>
        <div style={{padding: '30px',  border:'1px solid #E6ECF5', borderTop: 0}}>
            <div>
              ...
              <Row>
                <Col span={18} push={3}><a style={{color: '#1890FF'}} href={`mailto:${'loyalty.officer@unioil.com'}`}>loyalty.officer@unioil.com</a></Col>
            ...
            <div style={{margin: '12px 0 50px'}}>
              ...
              <Row>
                <Col span={18} push={3}>{'Administrator'}</Col>
